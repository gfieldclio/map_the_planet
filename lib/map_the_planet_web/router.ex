defmodule MapThePlanetWeb.Router do
  ...
  import MapThePlanetWeb.UserAuth
  ...
  scope "/", MapThePlanetWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{MapThePlanetWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", MapThePlanetWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{MapThePlanetWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", MapThePlanetWeb do
    ...
    live_session :current_user,
      on_mount: [{MapThePlanetWeb.UserAuth, :mount_current_user}] do
